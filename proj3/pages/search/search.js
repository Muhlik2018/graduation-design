...
Page({
    ...
    data: {
      ...
      },
      {
        ...
        mapColor: '#FFFFFF',
        floodImg:'/Assets/FloodFocus.svg',
        timeLineImg:'/Assets/TimeLine.svg',
        mapImg:'/Assets/Map.svg',
        floodDisp:'inline',
        timeLineDisp:'none',
        mapDisp:'none',
    },
    ...
    createNew(){
      ...
      clickTimeLine(){
        this.setData({
          floodColor:'#FFFFFF',
          timeLineColor: '#FF961C',
          mapColor: '#FFFFFF',
          floodImg:'/Assets/Flood.svg',
          timeLineImg:'/Assets/TimeLineFocus.svg',
          mapImg:'/Assets/Map.svg',
          floodDisp:'none',
          timeLineDisp:'inline',
          mapDisp:'none',
      ...
      viewChange(e){
        console.log(e.detail.changeInfo);
      }
